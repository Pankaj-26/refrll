...
//     }
//   }, [dispatch, jobId, currentPage, filters.status, filters.search]);
...
//         (app) =>
//           app?.seeker?.profile?.experience >= parseInt(filters.experienceMin)
//       );
//     }
//     if (filters.experienceMax) {
//       result = result.filter(
//         (app) =>
//           app?.seeker?.profile?.experience <= parseInt(filters.experienceMax)
//       );
//     }
...
//           (app?.seeker?.profile?.skills || []).some((skill) =>
